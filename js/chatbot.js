...
- จุดเด่น: 
  ...
  * วางระบบบัญชีออนไลน์ Cloud Accounting (Certified Partner: PEAK, FlowAccount) ดูงบการเงิน Real-time ได้ 24 ชม.
...
- บริการหลัก 6 มิติ:
  1. รับทำบัญชีและยื่นภาษีรายเดือน (ภ.ง.ด.1, 3, 53, ภ.พ.30, สปส.)
  2. ปิดงบการเงินและตรวจสอบบัญชีโดย CPA
  3. จดทะเบียนจัดตั้งบริษัท / ห้างหุ้นส่วนจำกัด / จดทะเบียนพาณิชย์ / จด VAT
  4. วางแผนภาษีนิติบุคคลและที่ปรึกษาธุรกิจ (Tax Planning & Advisory)
  5. วางระบบโปรแกรมบัญชี Cloud Accounting (PEAK, FlowAccount)
  6. งานขอใบอนุญาตประกอบธุรกิจและงานทะเบียนราชการ
- แพ็กเกจราคาค่าบริการทำบัญชีรายเดือน:
  * Starter Package: เริ่มต้น 1,800 บาท/เดือน (เหมาะสำหรับฟรีแลนซ์/ธุรกิจเริ่มใหม่ เอกสาร 1-20 ชุด)
  * Growth SME Package: เริ่มต้น 3,500 บาท/เดือน (เหมาะสำหรับธุรกิจขนาดกลาง เอกสาร 21-60 ชุด รวมยื่น VAT และประกันสังคม)
  * Enterprise Pro: เริ่มต้น 6,500+ บาท/เดือน (ธุรกิจยอดขายสูง เอกสาร 60+ ชุด พร้อมวางแผนภาษีเชิงลึกและรายงานผู้บริหาร)
  * ค่าจดทะเบียนจัดตั้งบริษัท: เริ่มต้นเพียง 4,500 - 8,500 บาท (ขึ้นอยู่กับแพ็กเกจและรวมค่าธรรมเนียมราชการ)
- กำหนดยื่นภาษีสรรพากรที่สำคัญ:
  * ภ.ง.ด.1, 3, 53: ยื่นกระดาษภายในวันที่ 7 / ยื่นออนไลน์ e-Filing ภายในวันที่ 15 ของเดือนถัดไป
  * ภ.พ.30 (VAT): ยื่นกระดาษภายในวันที่ 15 / ยื่นออนไลน์ e-Filing ภายในวันที่ 23 ของเดือนถัดไป
  * เงินสมทบประกันสังคม: นำส่งภายในวันที่ 15 (กระดาษ) หรือ 29 (e-Service) ของเดือนถัดไป
  * ภ.ง.ด.51 (ภาษีนิติบุคคลครึ่งปี): ภายใน 2 เดือนนับแต่วันสุดท้ายของรอบ 6 เดือนแรก (สิงหาคม)
- ข้อมูลการติดต่อ ALL ACCOUNT:
  * โทรศัพท์: 065-829-1664 (สายด่วนปรึกษาฟรี)
...
2. ถ้าลูกค้าสอบถามราคา ให้แจ้งช่วงราคาประเมินเบื้องต้น และแนะนำให้ใช้ "ระบบคำนวณราคาออนไลน์" บนหน้าเว็บ หรือทัก LINE เพื่อรับใบเสนอราคาอย่างเป็นทางการ
3. ถ้าเป็นคำถามเชิงลึกที่ต้องตรวจดูเอกสารเฉพาะราย ให้แนะนำติดต่อเจ้าหน้าที่ทาง LINE หรือเบอร์โทร 065-829-1664 ได้ฟรี
`;
...
function generateSmartFallbackReply(query) {
  ...
  if (q.includes("ราคา") || q.includes("แพ็กเกจ") || q.includes("ค่าบริการ") || q.includes("เท่าไหร่") || q.includes("กี่บาท") || q.includes("คำนวณ")) {
    return `💰 **อัตราค่าบริการทำบัญชีและภาษีรายเดือนของ ALL ACCOUNT:**\n\n` +
           `1. **Starter Package:** เริ่มต้น **1,800 บาท/เดือน**\n` +
           `   - เหมาะสำหรับฟรีแลนซ์ / กิจการขนาดเล็ก (เอกสารไม่เกิน 20 ชุด)\n` +
           `2. **Growth SME Package:** เริ่มต้น **3,500 บาท/เดือน**\n` +
           `   - เหมาะสำหรับบริษัท / หจก. ทั่วไป (เอกสาร 21-60 ชุด รวมยื่น VAT และประกันสังคม)\n` +
           `3. **Enterprise Pro:** เริ่มต้น **6,500+ บาท/เดือน**\n` +
           `   - สำหรับธุรกิจยอดขายสูง เอกสาร 60+ ชุด พร้อมที่ปรึกษาภาษีเชิงลึก\n\n` +
           `✨ ท่านสามารถเลื่อนไปที่ **"ระบบคำนวณราคาออนไลน์"** บนหน้าเว็บเพื่อประเมินราคาตามจริง หรือทัก LINE: [@861wjahj](https://line.me/R/ti/p/@861wjahj) เพื่อขอใบเสนอราคาได้ทันทีครับ`;
  }

  if (q.includes("จดทะเบียน") || q.includes("ตั้งบริษัท") || q.includes("เปิดบริษัท") || q.includes("หจก") || q.includes("นิติบุคคล")) {
    return `📋 **บริการจดทะเบียนจัดตั้งบริษัท & ห้างหุ้นส่วนจำกัด (ALL ACCOUNT):**\n\n` +
           `เราบริการจดทะเบียนธุรกิจแบบ One-Stop Service รวดเร็ว ถูกต้อง พร้อมเริ่มกิจการได้ทันที:\n` +
           `• บริการจองชื่อนิติบุคคล และตรวจชื่อตามระเบียบกรมพัฒนาธุรกิจการค้า (DBD)\n` +
           `• จัดทำหนังสือบริคณห์สนธิ ตราประทับ และเอกสารจัดตั้งครบชุด\n` +
           `• ดำเนินการยื่นขอจดทะเบียนพาณิชย์ / DBD e-Registration\n` +
           `• บริการขึ้นทะเบียนภาษีมูลค่าเพิ่ม (VAT ภ.พ.20) และขึ้นทะเบียนประกันสังคมนายจ้าง\n\n` +
           `📞 สนใจจดทะเบียนบริษัท ติดต่อสายด่วนได้ที่ **065-829-1664** หรือ LINE: [@861wjahj](https://line.me/R/ti/p/@861wjahj) เพื่อรับคำปรึกษาฟรีครับ`;
  }
